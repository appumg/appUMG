...
public class adapter_lista_pensum  extends BaseExpandableListAdapter{
    ...
    public adapter_lista_pensum(Context contexto, HashMap<String, List<String>> horario_semestre, List<String> horario_lista, ArrayList<horario_pensum>s) {
    ...
    public View getChildView(int padre, int hijo, boolean ultimoHijo, View convertView, ViewGroup vistaPadre) {
        ...
        {
            LayoutInflater inflador=(LayoutInflater)contexto.getSystemService(contexto.LAYOUT_INFLATER_SERVICE);
            convertView=inflador.inflate(R.layout.hijo_lista_expansible_pensum, vistaPadre,false);
        }
        TextView hijoText=(TextView)convertView.findViewById(R.id.TV_curso);

        hijoText.setText(hijo_titulo);

        TextView codCurso=(TextView)convertView.findViewById(R.id.TV_CodCurso);
        codCurso.setText(hora_curso.get(padre).getCodigoCurso(hijo));

        TextView Creditos=(TextView)convertView.findViewById(R.id.TV_creditos);
        Creditos.setText(hora_curso.get(padre).getCreditos(hijo));

        TextView requisitos=(TextView)convertView.findViewById(R.id.TV_requisitos);
        ...
        if(hijo==0 && hijo_titulo=="Curso")
            {
                ...
                Creditos.setTypeface(null,Typeface.BOLD);
                Creditos.setTextColor(Color.parseColor("#353535"));
        ...
        else
        {
            ...
            Creditos.setTypeface(null,Typeface.NORMAL);
            Creditos.setTextColor(Color.parseColor("#686868"));
